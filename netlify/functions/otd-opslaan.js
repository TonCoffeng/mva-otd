  ...
  try {
    ...
    if(event.httpMethod === 'POST'){
      ...
      const dossier = {
        ...
        zoek_aantal_kamers: body.zoek_aantal_kamers || null,
        zoek_buitenruimte: body.zoek_buitenruimte || null,
        zoek_overig: body.zoek_overig || null,
        datum_opdracht: parseNLDate(body.datum_opdracht),
        courtage_type: ct,
        courtage_model: body.courtage_model || (ct==='vast_bedrag' ? 'vast' : 'percentage'),
        courtage_pct_incl: parseNLNum(body.courtage_pct),
        courtage_vast_bedrag: parseNLNum(body.courtage_vast),
        courtage_meerprijs_waarde: parseNLNum(body.courtage_meerprijs_waarde),
